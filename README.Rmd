...
**A lot has changed with `tvthemes 1.0.0` so please check the README section below rather than the blogpost.**
...
Also, there is nothing stopping you from mixing the `theme` and `palette`, below: `"Day" palette` with `"Night" theme`!
