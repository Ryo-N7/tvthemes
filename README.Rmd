...
### Game of Thrones: Martell, Stannis Baratheon, Manderly

```{r, fig.width=15, fig.height = 10}
mpg %>% 
  ggplot(aes(displ)) +
  geom_histogram(aes(fill = class), col = "black", size = 0.1) +
  scale_fill_westeros(palette = "Manderly", n = 7, reverse = TRUE) +
  ...
  theme(text = element_text(family = "Cinzel", size = 20),
        title = element_text(family = "Cinzel", size = 24)) 
...
mpg %>% 
  filter(!class %in% c("suv", "subcompact")) %>% 
  ggplot(aes(displ)) +
  geom_histogram(aes(fill = class), col = "black", size = 0.1) +
  scale_fill_arryn() +
  labs(title = "The North remembers Lord Davos. The North remembers...",
...
mpg %>% 
  ggplot(aes(displ)) +
  geom_histogram(aes(fill = rev(class)), col = "black", size = 0.1) +
  scale_fill_bigHero6(reverse = TRUE) +
  labs(title = "On That Day, Mankind Received A Grim Reminder...",
       subtitle = "TITANS ARE MY TRIGGER",
       caption = "W-Well I'll Just Bertell You What I Berthold Him..") +
    theme_simpsons(ticks = TRUE)
```
...
ggplot(data = data, aes(x = year, y = gdpPercap, fill = country)) +
  ...
  labs(title = "What's The Sitch, Wade?",
       ...
       caption = "Stoppable... What Are You Doing In My House??",
       x = "Year", y = "GDP per Capita") +
  theme_hilda(title.font = "Roboto Condensed",
              text.font = "Roboto Condensed",
              title.size = 24,
              subtitle.size = 20,
              text.size = 18,
...
mpg %>% 
  ...
  scale_x_continuous(expand = c(0, 0)) +
  scale_y_continuous(expand = c(0, 0)) +
  scale_fill_hilda(palette = "Day", reverse = TRUE) +
  labs(title = "On That Day, Mankind Received A Grim Reminder...",
       subtitle = "TITANS ARE MY TRIGGER",
       caption = "W-Well I'll Just Bertell You What I Berthold Him..") +
...
ggplot(faithfuld, aes(waiting, eruptions, fill = density)) + 
  geom_tile() +
  scale_fill_hilda(palette = "Night", type = "continuous") +
  theme_hilda()

ggplot(faithfuld, aes(waiting, eruptions, fill = density)) + 
  geom_tile() +
  scale_fill_gradient2(low = "#586085", mid = "#F6E0D2", high = "#659794",
                       midpoint = 0.02) +
  theme_hildaDay()
```
